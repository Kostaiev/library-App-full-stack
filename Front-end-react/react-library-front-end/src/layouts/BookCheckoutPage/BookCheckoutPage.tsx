  ...
  useEffect(() => {
    const fetchBookReviews = async () => {
      ...
      if (!responseReviews.ok) {
        throw new Error("Samething went wrang!");
      }
      ...
      for (const key in responseData) {
        ...
        setTotalStars(responseData[key].rating);
      }
...
useEffect(() => {
  ...
  useEffect(()=>{
    const fetchUserCheckedOutBook = async () =>{
      ...
      const bookCheckedOutResposeJson = await bookCheckedOut.json();
      setIsCheckedOut(bookCheckedOutResposeJson);
    }
