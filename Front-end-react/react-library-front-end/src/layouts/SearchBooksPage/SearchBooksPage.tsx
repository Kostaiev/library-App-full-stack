...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      if (searchUrl === "") {
        url = `${baseUrl}?page=${curentPage - 1}&size=${booksPerPage}`;
      } else {
  ...
  const indexOfLastBook: number = curentPage * booksPerPage;
  const indexOfFirstBook: number = indexOfLastBook - booksPerPage;
  let lastItem =
    booksPerPage * curentPage <= totalAmountOfBooks
      ? booksPerPage * curentPage
      : totalAmountOfBooks;
